...
<body>
	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h4 class="page-head-line">Actualizar Perfil</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<form action="actualizarClientePostAction">
						...
						<label>Nombres : </label> <input type="text" readonly="readonly"
							class="form-control" name="nombres"
							value="<s:property value='nombres' />"> <label>A.
							Paterno : </label> <input type="text" readonly="readonly"
							class="form-control" name="paterno"
							value="<s:property value='paterno' />"> <label>A.
							Materno : </label> <input type="text" readonly="readonly"
							class="form-control" name="materno"
							value="<s:property value='materno' />"> <label>DNI
							: </label> <input type="text" readonly="readonly" class="form-control"
							name="dni" value="<s:property value='dni' />"> <label>Correo
